  ...
  _nextCard(direction, x, y, duration=400){
    ...
    switch (direction) {
      case 'left':
        ...
        this.state.cards[index-2].props.onSwipedLeft();
        break;
      case 'right':
        this.props.onSwipedRight();
        this.state.cards[index-2].props.onSwipedRight();
        break;
      case 'top':
        this.props.onSwipedTop();
        this.state.cards[index-2].props.onSwipedTop();
        break;
      case 'bottom':
        this.props.onSwipedBottom();
        this.state.cards[index-2].props.onSwipedBottom();
        break;
      default:
